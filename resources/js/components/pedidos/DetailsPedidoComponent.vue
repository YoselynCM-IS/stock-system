<template>
    <div>
        <b-row>
            ...
            <b-col sm="1">
                <b-button v-if="(role_id == 1 || role_id == 2 || role_id == 6 || role_id == 10) && pedido.estado == 'de inventario' && pedido.cerrado_por == null"
            ...
            <b-col sm="2">
                <b-button v-if="(role_id == 1 || role_id == 2 || role_id == 6 || role_id == 10) && pedido.estado == 'proceso'"
